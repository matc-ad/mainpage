...
import { redireccions, colorsOptions } from '../constants';
...
const Totes = ({ isDarkMode }) => {
    ...
    const sortedRedireccions = [...redireccions].sort((a, b) => a.page.localeCompare(b.page));

    return (
        <section id="redireccions" className={`py-5 ${colors.background} ${colors.text}`}>
            <div className="container mx-auto text-center px-4">
                <h2 className={`text-4xl font-extrabold ${colors.title}`}>Les redireccions</h2>
                <p className={`mt-4 text-lg ${colors.description}`}>Explora les redireccions.</p>
